...
public:
    ...
    list<ball *> trailingParticles; //list of trailing particles
    
    //Different types of constructors
    ball(point * position, float size); //meant for trailing particle no direction - don't move
    ball(point * position, point * direction, float size, float lifespan);
    ball(point * position, point * direction, float speed, float size, float lifespan);
    ball(point * position, point * direction, float speed, float size, float lifespan, int * color);
